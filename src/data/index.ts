...
export const SocialMedia = [
	...
	{
		name: "Instagram",
		link: "https://www.instagram.com/arthuronit/",
		icon: InstagramIcon,
	},
	{ name: "Github", link: "https://github.com/ebarthur", icon: GitHubIcon },
	{
		name: "LinkedIn",
		link: "https://www.linkedin.com/in/ebarthur",
		icon: LinkedInIcon,
	},
] as const;
...
export const CurrentProjects: Project[] = [
	{
		title: "CookShare",
		techStack: ["TypeScript", "Nest.js", "Prisma ORM"],
		description: "A fully functional backend API for a recipe sharing platform",
		link: {
			label: "github.com",
			href: "https://github.com/ebarthur/cookshare-backend",
		},
	},
	{
		title: "Go Assistant",
		techStack: ["Gin", "Gorm", "Go"],
		description: "Your personal AI assistant built with Golang",
		link: {
			label: "github.com",
			href: "https://github.com/ebarthur/go-assistant",
		},
	},
	{
		...
		description:
			"A platform to track the pattern of power outages across Ghana",
		link: {
			label: "github.com",
